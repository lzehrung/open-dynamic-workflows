export const meta = {
  name: 'deep-research-verified',
  description: 'Deep research harness — fan-out web searches, fetch sources, adversarially verify claims, synthesize a cited report. Battle-tested port of the Claude Code built-in (100 agents / ~9 min end-to-end on the codex adapter, 2026-07-12).',
  whenToUse: 'When the user wants a deep, multi-source, fact-checked research report on any topic. Pass the research question as args (string). Requires an adapter with web search AND page-fetch capability (see docs/recipes/deep-research-verified.md for the codex adapter config). BEFORE invoking, check if the question is specific enough to research directly — if underspecified (e.g., "what car to buy" without budget/use-case/region), ask 2-3 clarifying questions to narrow scope. Then pass the refined question as args, weaving the answers in.',
